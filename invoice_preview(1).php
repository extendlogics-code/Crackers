...
<html lang="en">
  ...
  <body>
    <div class="sheet">
      ...
      <div class="totals">
        <div>
          <div style="border:1px solid #ddd;margin:6px 0 0 12px;padding:6px 10px;max-width:360px">
            <div><strong>Bank Name :</strong> <?= h($vendor['bank_name'] ?? 'ICICI') ?></div>
            <div><strong>Account No :</strong> <?= h($vendor['bank_ac'] ?? '101630666') ?></div>
            <div><strong>IFSC :</strong> <?= h($vendor['bank_ifsc'] ?? 'ICIC0000001') ?></div>
          </div>
        </div>
        <div class="sum">
